...
$(document).ready(function () {
  ...
  $("#SearchClientes").on("click", function (e) {
    e.preventDefault();
    var TelefonoS = document.getElementById("search1").value;
    var datos = {
      Telefono: TelefonoS
    };
    $.ajax({
      ...
      var NombreCompleto = Respuesta.clientes[0].Nombre + ' ' + Respuesta.clientes[0].ApellidoPater + ' ' + Respuesta.clientes[0].ApellidoMater;
...
/***/ 1:
/*!*********************************************!*\
  !*** multi ./resources/js/Ventas/Ventas.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\SistemasPizza\resources\js\Ventas\Ventas.js */"./resources/js/Ventas/Ventas.js");
